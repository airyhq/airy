...
The Airy Core is an open source, fully-featured, production ready
messaging platform.
...
You can run the Airy Core locally by running the following commands:
...
The Airy Core contains the following components:
...
code and tooling required to run the Airy Core.
...
The Airy Core is built using a few guiding principles. An introduction
...
To ensure a safe experience and a welcoming community, the Airy Core
