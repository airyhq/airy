...
maven_install(
    artifacts = [
        ...
        "io.github.openfeign:feign-core:10.5.1",
        ...
        "org.apache.kafka:kafka-clients:jar:test:2.4.1",
        ...
        "org.springframework.boot:spring-boot-loader:2.2.0.RELEASE",
        "org.springframework.boot:spring-boot-starter-actuator:2.2.0.RELEASE",
        "org.springframework.boot:spring-boot-starter-cache:2.2.0.RELEASE",
        "org.springframework.boot:spring-boot-starter-data-jpa:2.2.0.RELEASE",
        "org.springframework.boot:spring-boot-starter-jetty:2.2.0.RELEASE",
        ...
        "org.springframework.boot:spring-boot-starter-websocket:2.2.0.RELEASE",
