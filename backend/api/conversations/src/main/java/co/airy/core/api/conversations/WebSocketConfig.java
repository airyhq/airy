...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry
            .addEndpoint("/ws")
            .setAllowedOrigins("*");
        //TODO: SockJS should be revisited once webapp integration is at a stage where it can be tested on browsers.
        // lack of native websocket support on browsers that are deemed mandatory, will make us bring SockJS back.
        //.withSockJS();
    }
