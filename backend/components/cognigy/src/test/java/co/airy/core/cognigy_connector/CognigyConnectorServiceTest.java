...
public class CognigyConnectorServiceTest {
    @RegisterExtension
    ...
    @Test
    public void callsCognigyClientSendWhenMessageIsValid() throws Exception {
        //given
        ...
        //then
        retryOnException(() -> {
            verify(cognigyClient).sendMessage(messageSendArgumentCaptor.capture());
