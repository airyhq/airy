...
class ConversationsInfoTest {
    ...
    void canFetchConversationsInfo() throws Exception {
        ...
        kafkaTestHelper.produceRecords(List.of(
                new ProducerRecord<>(Topics.applicationCommunicationUsers.name(), user.getId(), user),
                new ProducerRecord<>(Topics.applicationCommunicationMetadata.name(), getId(metadata).toString(), metadata),
                new ProducerRecord<>(Topics.applicationCommunicationChannels.name(), channel.getId(), channel)
        ));
