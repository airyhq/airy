...
import static co.airy.core.communication.util.TestConversation.generateRecords;
...
public class MetadataControllerTest {
    ...
    static void beforeAll() throws Exception {
        ...
        kafkaTestHelper.produceRecord(new ProducerRecord<>(Topics.applicationCommunicationChannels.name(), channel.getId().toString(), channel));
    }
    ...
    void canUpsertMetadata() throws Exception {
        ...
        final List<ProducerRecord<String, SpecificRecordBase>> producerRecords = TestConversation.generateRecords(conversationId, channel, 1);
