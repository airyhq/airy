...
public class SendMessageControllerTest {
    ...
    void canSendMessage() throws Exception {
        ...
        List<ConsumerRecord<String, Message>> records = kafkaTestHelper.consumeRecords(2, Topics.applicationCommunicationMessages.name());
        ...
        kafkaTestHelper.produceRecord(new ProducerRecord<>(Topics.applicationCommunicationMessages.name(), message.getId(), message));
