...
public class IbmWatsonAssistantConnectorServiceTest {
    @RegisterExtension
    ...
    @Test
    public void callsIbmWatsonAssistantClientSendWhenMessageIsValid() throws Exception {
        //given
        ...
        //then
        retryOnException(() -> {
            verify(ibmWatsonAssistantClient).sendMessage(messageSendArgumentCaptor.capture());
            MessageSend sentMessage = messageSendArgumentCaptor.getValue();
            assertThat(sentMessage.getText(), equalTo(textMessage));
