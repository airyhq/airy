...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = AirySpringBootApplication.class,
        properties = {
                "twilio.token=whatever",
        })
@AutoConfigureMockMvc
@ExtendWith(SpringExtension.class)
class TwilioControllerIntegrationTest {
    @RegisterExtension
    ...
    void failsForUnauthenticated() throws Exception {
        ...
        final String validationSignature = getValidationSignature("http://localhost/twilio", parameters, "DROP TABLE");
    ...
    void canAcceptRequests() throws Exception {
        ...
        final String validationSignature = getValidationSignature("http://localhost/twilio", parameters, twilioAuthToken);
    ...
    private String getValidationSignature(String url, Map<String, String> params, String authToken) {
        try {
