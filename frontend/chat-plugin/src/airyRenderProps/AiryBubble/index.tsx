      ...
      {!props.isChatHidden ? (
        <svg width="24px" height="60px" viewBox="0 0 10 6" version="1.1">        
          <g id="Page-1" stroke="none" stroke-width="1" fill="#ffffff" fill-rule="evenodd">
            <g id="chevron-down" transform="translate(1.000000, 1.000000)" fill="#ffffff" fill-rule="nonzero" stroke="#ffffff">
              <path d="M7.1746043,0.1203717 C7.3842672,-0.05933938 7.6999172,-0.03505861 7.8796283,0.1746043 C8.0593394,0.3842672 8.0350586,0.6999172 7.8253957,0.8796283 L4.3253957,3.8796283 C4.1381508,4.0401239 3.8618492,4.0401239 3.6746043,3.8796283 L0.17460431,0.8796283 C-0.03505861,0.6999172 -0.05933938,0.3842672 0.1203717,0.1746043 C0.30008277,-0.03505861 0.61573277,-0.05933938 0.82539569,0.1203717 L3.99999093,2.8414611 L7.1746043,0.1203717 Z" id="Path"/>
            </g>
          </g>
        </svg>
      ) : (
