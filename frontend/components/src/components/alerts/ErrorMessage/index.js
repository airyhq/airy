...
var fogg_waiting_png_1 = __importDefault(
  require("../../../assets/images/pictures/fogg-waiting.png")
);
...
var ErrorMessageComponent = function(_a) {
  ...
  return react_1["default"].createElement(
    ...
    react_1["default"].createElement(
      "div",
      { className: style_module_scss_1["default"].headerError },
      ...
      react_1["default"].createElement(
        ...
        react_1["default"].createElement(
          "p",
          null,
          text || t("alerts.linkExpired")
        )
      )
    ),
    react_1["default"].createElement("img", {
      src: fogg_waiting_png_1["default"],
      className: style_module_scss_1["default"].errorImage,
      alt: "Airy Waiting"
    })
  );
};
