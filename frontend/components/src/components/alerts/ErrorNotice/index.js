...
var exclamation_svg_1 = __importDefault(
  require("../../../assets/images/icons/exclamation.svg")
);
...
var ErrorNoticeComponent = function(_a) {
  ...
  return react_1["default"].createElement(
    ...
    {
      className:
        style_module_scss_1["default"].container +
        " " +
        style_module_scss_1["default"][theme]
    },
    react_1["default"].createElement(
      "div",
      { className: style_module_scss_1["default"].iconWrapper },
      react_1["default"].createElement(AccessibleSVG_1.AccessibleSVG, {
        ariaHidden: "true",
        src: exclamation_svg_1["default"]
      })
    ),
    children
  );
