...
exports.ErrorPopUp = function (props) {
    var message = props.message, closeHandler = props.closeHandler;
    return (react_1["default"].createElement("div", { className: style_module_scss_1["default"].main },
        react_1["default"].createElement("div", { className: style_module_scss_1["default"].errorContainer },
            ...
            react_1["default"].createElement("button", { onClick: function () { return closeHandler(); } },
                react_1["default"].createElement(react_svg_1.ReactSVG, { src: close_svg_1["default"] })))));
};
