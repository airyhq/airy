...
exports.Button = function (_a) {
    var children = _a.children, onClick = _a.onClick, type = _a.type, styleVariant = _a.styleVariant, disabled = _a.disabled, tabIndex = _a.tabIndex;
    ...
    return (react_1["default"].createElement("button", { type: type || 'button', disabled: disabled || false, className: styleFor(styleVariant), onClick: onClick, 
        //@ts-ignore
