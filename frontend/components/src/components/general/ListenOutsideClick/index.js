...
var ListenOutsideClick = function (_a) {
    var children = _a.children, className = _a.className, onOuterClick = _a.onOuterClick;
    ...
    return (react_1["default"].createElement("div", { className: className, ref: innerRef }, children));
};
