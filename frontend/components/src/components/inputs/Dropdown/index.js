...
exports.Dropdown = function(_a) {
  ...
  var _b = react_1.useState(false),
    dropdownVisible = _b[0],
    setDropdownVisible = _b[1];
  ...
  var keyDownHandler = react_1.useCallback(
    function(e) {
      if (e.key === "Escape") {
        showDropdown(false);
      }
  ...
  var eventHandler = react_1.useCallback(
    function(e) {
  ...
  return react_1["default"].createElement(
    "div",
    { className: style_module_scss_1["default"].component, ref: componentEl },
    react_1["default"].createElement(
      "button",
      {
        ...
        type: "button",
        onClick: function() {
          return showDropdown(!dropdownVisible);
        }
      },
      ...
      react_1["default"].createElement(AccessibleSVG_1.AccessibleSVG, {
        ...
        className:
          style_module_scss_1["default"].chevron +
          " " +
          (dropdownVisible ? style_module_scss_1["default"].chevronRotated : "")
      })
    ),
    dropdownVisible &&
      react_1["default"].createElement(
        "div",
        { className: style_module_scss_1["default"].dropDown },
        options.map(function(option) {
          return react_1["default"].createElement(
            "button",
            {
              type: "button",
              key: option,
              className: style_module_scss_1["default"].item,
              onClick: function() {
                return itemSelected(option);
              }
            },
            option
          );
