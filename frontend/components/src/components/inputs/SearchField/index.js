...
exports.SearchField = function(_a) {
  var id = _a.id,
    ...
    resetClicked = _a.resetClicked,
    autoFocus = _a.autoFocus;
  var inputRef = react_1.createRef();
  var resetButton = react_1.useCallback(
    function() {
      setValue("");
      if (resetClicked) {
        resetClicked();
  ...
  return react_1["default"].createElement(
    "div",
    { className: style_module_scss_1["default"].component },
    react_1["default"].createElement(AccessibleSVG_1.AccessibleSVG, {
      ariaHidden: "true",
      src: search_svg_1["default"],
      className: style_module_scss_1["default"].searchIcon
    }),
    ...
    value !== "" &&
      react_1["default"].createElement(
        "button",
        {
          className: style_module_scss_1["default"].resetButton,
          onClick: resetButton,
          title: "Reset Search"
        },
        react_1["default"].createElement(AccessibleSVG_1.AccessibleSVG, {
          ...
          className: style_module_scss_1["default"].closeIcon
        })
      )
  );
};
