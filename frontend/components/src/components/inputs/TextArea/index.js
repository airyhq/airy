...
var react_autosize_textarea_1 = __importDefault(
  require("react-autosize-textarea")
);
...
var TextAreaComponent = /** @class */ (function(_super) {
  ...
  function TextAreaComponent() {
    ...
    _this.renderComponent = function(props) {
      var id = props.id,
        ...
        currentValidationState = props.currentValidationState;
      var inputClass =
        style_module_scss_1["default"].textarea +
        " " +
        (fontClass || "font-l") +
        " " +
        _this.classForState(currentValidationState);
      return react_1["default"].createElement(
        react_autosize_textarea_1["default"],
        {
          id: id,
          ref: inputRef,
  ...
  TextAreaComponent.prototype.render = function() {
    return react_1["default"].createElement(
      Input_1.Input,
      __assign({}, this.props, { inputComponent: this.renderComponent }),
      this.props.children
    );
  };
