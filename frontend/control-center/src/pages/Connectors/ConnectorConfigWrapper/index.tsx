...
const ConnectorConfigWrapper = (props: ConnectorConfigProps) => {
  ...
  console.log('CONNECTOR CONFIG WRAPPER CONNECTOR', connector);

  const params = useParams();
  const {channelId, source} = useParams();
  console.log('CONNECTOR CONFIG WRAPPER PARAMS', params);
  ...
  useEffect(() => {
    console.log('CONNECTOR CONFIG WRAPPER - backRoute', backRoute);
  }, [backRoute]);
  ...
  }, [source, channelId, Object.entries(catalog).length > 0]);
