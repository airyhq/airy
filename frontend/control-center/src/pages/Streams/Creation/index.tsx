...
const Creation = (props: ListModeProps) => {
  ...
  return (
    <div className={styles.container}>
      <p className={styles.titleSection}>Select the topics: </p>
          ...
          {savedFields && (
            <>
              ...
              {!!selectedFieldsForJoins.length && (
                <>
                  <p className={styles.titleSection}>Current fields to join selected:</p>
                    ...
                    {selectedFieldsForJoins.map(joinObject => {
                      return (
                        ...
                        >
                          ...
                          <ArrowDownIcon />
                          <div className={styles.selectedJoinsText}>JOIN INTO</div>
                          <ArrowDownIcon />
                          <div className={styles.selectedJoinsName}>{joinObject['name']}</div>
                        </div>
                      );
                    })}
                  </div>
              ...
              <p className={styles.titleSection}>Select fields to join:</p>
              ...
              {currentJoinSelection1 && currentJoinSelection2 && (
                <div className={styles.fieldNameSection}>
                  <Input
                    ...
                    type="text"
                    id="text"
                    label="Name of field in new topic"
