      ...
      {Object.entries(topics).length > 0 ? (
        <>
          <div className={styles.listHeader}>
            <h2>{t('name')}</h2>
            <Button
              className={`${mode === TopicsMode.select ? styles.listHeaderButtonConfirm : styles.listHeaderButton}`}
              styleVariant="green"
              onClick={() => {
            ...
            >
              {mode === TopicsMode.select ? t('confirm').toLocaleUpperCase() : 'CREATE'}
            </Button>
            {mode === TopicsMode.select && (
              <Button
