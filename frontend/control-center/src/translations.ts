...
const resources = {
  ...
  fr: {
    translation: {
      ...
      //Channels
      chatpluginTitle: 'Chat Plugin',
      chatpluginDescription: 'Le meilleur messager de navigateur de sa catégorie',
      facebookTitle: 'Facebook Messenger',
      ...
      save: 'Sauvez',
      delete: 'Supprimer',
      deleteChannel: 'Voulez-vous vraiment supprimer cette chaîne?',
      ...
      imageUrlPlaceholder: '(facultatif) ajouter une image url',
      imageUrlHint: 'max. 1024x1024 pixel PNG',
      ...
      inboundBackgroundColor: `Couleur d'arrière-plan pour les appels entrants`,
      inboundTextColor: 'Couleur du texte entrant',
      outboundBackgroundColor: `Couleur d'arrière-plan de la sortie`,
      ...
      startNewConversationText: 'Commencer une nouvelle conversation Texte',
      ...
      addImageurlOptional: '(facultatif) ajouter une image url',
      heightPx: 'Hauteur (min 200px)',
      customHeightPlaceholder: '(facultativement) ajouter une hauteur personnalisée',
      widthPx: 'Largeur (min 200px)',
      customWidthPlaceholder: '(facultativement) ajouter une largeur personnalisée',
      disabledForMobile: 'Handicapés pour les mobiles',
      ...
      facebookConfigurationText3: 'Un jeton de page pour chaque page Facebook que vous souhaitez intégrer.',
      ...
      instagramConfigurationText4: 'Un jeton de page pour chaque page Facebook que vous souhaitez intégrer.',
      ...
      notFound: `Oups! Nous n'avons pas pu trouver ça ici.`,
      ...
      subscribeWebhook: 'Abonnement au Webhook',
      updateWebhook: 'Mise à jour du Webhook',
      unsubscribeWebhook: 'Désabonnement Webhook',
      unsubscribeWebhookText: 'Vous êtes sûr de',
      unsubscribeWebhookText2: 'vouloir vous désabonner ',
      unableToUnsubscribeWebhook: 'Impossible de désabonner le Webhook',
      subscribeCapital: `S'abonner à`,
  ...
  es: {
    translation: {
      ...
      twilioSmsTitle: 'SMS',
      twilioSmsDescription: 'Entrega de SMS con facilidad',
      twilioWhatsappTitle: 'WhatsApp',
      twilioWhatsappDescription: 'Aplicación de chat número 1 del mundo',
      channel: 'canal',
      channels: 'canales',
      ...
      facebookConfigurationText:
        'Una identificación y un secreto de la aplicación para que la plataforma pueda enviar mensajes a través de tu aplicación de Facebook',
      facebookConfigurationText2:
