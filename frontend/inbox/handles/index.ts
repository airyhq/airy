...
export const cyCancelEditContactIcon = 'cancelEditContactIcon';
export const cyContactEmail = 'contactEmail';
export const cyContactPhone = 'contactPhone';
export const cyContactTitle = 'contactTitle';
export const cyContactAddress = 'contactAddress';
export const cyContactCity = 'contactCity';
export const cyContactOrganization = 'contactOrganization';
export const cyContactExtendable = 'contactExtendable';
export const cyContactSaveButton = 'contactSaveButton';
