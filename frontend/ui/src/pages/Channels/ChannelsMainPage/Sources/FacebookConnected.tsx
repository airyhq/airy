...
import styles from './FacebookConnected.module.scss';
...
const FacebookConnected = (props: FacebookConnectedProps) => {
    ...
    return (
        ...
        {channels.map((channel: Channel) => {
            <div className={styles.channelRow}>
                ...
                <Button styleVariant='outline'>{channel.connected}</Button>
...
export default withRouter(connector(FacebookConnected));
