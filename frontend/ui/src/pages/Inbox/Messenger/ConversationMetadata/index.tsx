...
//import {ConversationMetadataTags} from './ConversationMetadataTags';
        ...
        <div className={styles.metaPanel}>
          <div className={styles.contact}>
            ...
            <div className={styles.displayNameContainer}>
              {showEditDisplayName ? (
                <DisplayName showEditDisplayName={showEditDisplayName} setShowEditDisplayName={setShowEditDisplayName} />
              ) : (
                <>
          ...
          <div className={styles.tags}>
            ...
            {/* //{showTagsDialog && <ConversationMetadataTags />} */}
