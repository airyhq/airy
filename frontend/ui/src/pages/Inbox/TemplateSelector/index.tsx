    ...
    return (
        <ListenOutsideClick onOuterClick={onClose}>
            <div className={styles.container} ref={componentRef}>
                {listTemplatesError ?
                    <ErrorNotice theme="error">Oops! Your templates could not be loaded. Please try again
                        later.</ErrorNotice> : templates.length === 0 && source === templatesSource ? (
                        renderEmpty()
                    ) : (
                        <>
                                    ...
                                    templatesList.map((template, id) => {
                                        return (
                                            <div
                                                ...
                                                <SourceMessage content={template} source={template.source}
