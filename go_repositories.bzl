...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:xZBdJmgkTQuIrbq5jSi5gyUwyz4eRTvjmLoT+c+Ao/A=",
        version = "v1.44.21",
    )
    ...
    go_repository(
        ...
        sum = "h1:PrzhYjDpWnGSpjedmEapldQKPW4x8cCNzUI8XOho1CM=",
        version = "v1.15.7",
    )
    go_repository(
        ...
        sum = "h1:tX4EHQFU4+O9at5QjnwIKb/Qgv7MbgbUNtqTRF0Vu2M=",
        version = "v1.12.2",
    )
    go_repository(
        ...
        sum = "h1:YPxclBeE07HsLQE8vtjC8T2emcTjM9nzqsnDi2fv5UM=",
        version = "v1.12.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:j0VqrjtgsY1Bx27tD0ysay36/K4kFMWRp9K3ieO9nLU=",
        version = "v1.3.12",
    )
    ...
    go_repository(
        ...
        sum = "h1:ZuDiiY51GwGqYZ3NVMhRxqyolRy2JN4RGE1ERZ+GdyU=",
        version = "v1.44.0",
    )
    go_repository(
        ...
        sum = "h1:CYRfUZNq2krWxqLE1ntvy40uVT/I6X1PniNHrE/W3ps=",
        version = "v1.21.1",
    )
    go_repository(
        ...
        sum = "h1:NUT8HreIoLAfPAP7eEYN8jwidvY+4TjZ86xqS/iGDQI=",
        version = "v1.18.5",
    )
    ...
    go_repository(
        ...
        sum = "h1:gRW1ZisKc93EWEORNJRvy/ZydF3o6xLSveJHdi1Oa0U=",
        version = "v1.9.5",
    )
    go_repository(
        ...
        sum = "h1:TfJ/zuOYvHnxkvohSwAF3Ppn9KT/SrGZuOZHTPy8Guw=",
        version = "v1.11.5",
    )
    go_repository(
        ...
        sum = "h1:aYToU0/iazkMY67/BYLt3r6/LT/mUtarLAF5mGof1Kg=",
        version = "v1.16.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:vLDp++YAX7iy2y2CVPJNy9pk9CY8XaUKgHkjbVtnWag=",
        version = "v0.11.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/EZ/nPaLUzeJKF/BuJ4QCuMVJWiEVoI8iftOHY3g3tk=",
        version = "v0.13.7",
    )
    ...
    go_repository(
        ...
        sum = "h1:K7wO6V1IrczY9QOQ2WkVpw4JQSwCd52UsxVEirZUfiw=",
        version = "v0.0.0-20220630215102-69896b714898",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qDSWViuF6SzZX5s5AB/NVRGWmdao7T5j4S4ebIkMGag=",
        version = "v3.9.0",
    )
