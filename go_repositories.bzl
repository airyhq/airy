...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:nBQrWPlrNIiw0BsX6a6MKr1itkm0ZS0Nl97kNLitFfI=",
        version = "v0.0.0-20220413171646-5e7f5fdc6da6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:xTaFYiPROfpPhqrfTIDXj0ri1SpfueYT951s4bAuDO8=",
        version = "v0.0.0-20220524220425-1d687d428aca",
    )
    go_repository(
