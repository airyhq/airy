...
kubectl scale deployment sources-twilio-events-router --replicas=1
kubectl scale deployment sources-twilio-sender --replicas=1
kubectl scale deployment sources-twilio-webhook --replicas=1
