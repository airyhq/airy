...
kubectl scale deployment sources-twilio-events-router --replicas=0
kubectl scale deployment sources-twilio-sender --replicas=0
kubectl scale deployment sources-twilio-webhook --replicas=0
