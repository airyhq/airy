...
import co.airy.core.sources.meta.api.Mapper;
...
public abstract class MetaConnector {
    ...
    MetaConnector(Logger log, Api api, Mapper mapper) {
        this.log = log;
        this.api = api;
        this.mapper = mapper;
    }
    ...
    public abstract UserProfile getUserProfile(Conversation conversation);
}
